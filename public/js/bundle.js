...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY3llbG9uczQ1IiwiYSI6ImNrYTdwYXdsbDA1ZmMycW83ZXBjaGh5aGsifQ.fnxRmg2p1_Wo67ZQreqkRA';
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return _axios.default.post("http://127.0.0.1:4000/api/v1/users/signup", persDetails);

          case 4:
            res = _context3.sent;
            (0, _alerts.showAlert)('success', 'You are sign in.');
            if (res.data.status === 'success') window.setTimeout(function () {
              location.assign('/');
            }, 100); // location.reload(true);
            // window.setTimeout((res),1000)
...
var stripe = Stripe('pk_test_lvFdzScST1O5Jf4gqhdR2HLX00FWlvJgBW');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://127.0.0.1:4000/api/v1/booking/checkout-session/".concat(tourId));
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Error Checking out! Try again');
...
var tour_Payment = document.getElementById('book-tour'); // const sideNav = document.querySelectorAll('.side-nav');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // if (accountBtn) accountBtn.addEventListener('click', account);
